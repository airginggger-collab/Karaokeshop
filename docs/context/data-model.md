...
Самое срочное — заполнить `product` по всем актуальным системам AST и Studio Evolution (модель, бренд, сценарий, площадь, цена, состав, песни, фото). Формат: Excel/Google Sheets по колонкам выше → импортируем в CMS. См. [бриф, блок 4](../client/client-brief.md).
