...
- 🧪 [QA-прогон 2026-06-25](qa-2026-06-25.md) — функциональный прогон LIVE: находки (бюджет-плацебо, og.jpg, крошки, Метрика) + статусы «исправлено».
- 🏛 [ARCHITECTURE.md](ARCHITECTURE.md) — единый архитектурный обзор: слои, роутинг, данные, деплой, дорожная карта.
