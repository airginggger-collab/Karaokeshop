...
>
> **Обновлено: 2026-07-05 — Task 5 дизайн-спринта «Сцена» (лендинги); до этого фикс opacity-модификаторов Tailwind, 2026-07-04 (3) — Task 4 (каталог+товар).** Ветка `main` — актуальная, деплоится на Cloudflare автоматически. Сборка чистая, тесты зелёные (web 24 + ui 2), CI/деплой зелёный.
>
...
## Последняя сессия (2026-07-05) — Task 5 дизайн-спринта «Сцена»: лендинги
