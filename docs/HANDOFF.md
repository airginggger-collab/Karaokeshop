...
- **Плюс готовые промпты для Google Stitch (тёмная тема)** — EN + RU версии под поле промпта Stitch + таблица маппинга на UI-панель Stitch (Mode=Dark, Primary `#7250F8`, Background `#0B0913`, Font Manrope/Unbounded, radius 8px).
