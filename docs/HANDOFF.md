...
>
> **Обновлено: 2026-07-06 — Task 6d дизайн-спринта «Сцена» (замыкающий фикс-коммит после финального адверсариального ревью — сломанный `text-destructive` на `/servis`, семантические токены success/danger, бейдж скидки 11px, заголовки блога); до этого Task 6c (полировка a11y/perf — ДИЗАЙН-СПРИНТ «СЦЕНА» ЗАВЕРШЁН, Task 1–6), Task 6b (чистка мёртвого кода), Task 6a (визуальные must-фиксы), Task 5 (лендинги, 2026-07-05).** Ветка `main` — актуальная, деплоится на Cloudflare автоматически. Сборка чистая, тесты зелёные (web 24 + ui 2), CI/деплой зелёный.
>
...
## Последняя сессия (2026-07-06) — Task 6d дизайн-спринта «Сцена»: замыкающий фикс-коммит после финального ревью
