  ...
  return (
    <Container className="py-10">
      ...
      <p className="mt-3 max-w-2xl text-muted-foreground">
        Личный кабинет: визуальный редактор сайта. Вы меняете товары, цены, тексты, фото и статьи через
      ...
      <section className="mt-10 rounded-xl border border-border bg-background p-6">
        ...
        <p className="mt-4 rounded-lg bg-surface p-3 text-xs text-muted-foreground">
          Токен и есть ваш ключ к сайту. Никому его не передавайте. Если понадобится отозвать доступ,
